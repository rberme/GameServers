...
namespace YunLoong
{
    ...
    public class UsingLock<T>
    {
        ...
        private struct Lock : IDisposable
        {
            ...
            public Lock(ReaderWriterLockSlim rwl)
            {
                _Lock = rwl;
            }
        ...
        public T Data
        {
            get
            {
                if (_LockSlim.IsReadLockHeld || _LockSlim.IsWriteLockHeld || _LockSlim.IsUpgradeableReadLockHeld)
                {
                    return _Data;
                }
        ...
        {
            if (Enabled == false || _LockSlim.IsReadLockHeld || _LockSlim.IsUpgradeableReadLockHeld || _LockSlim.IsWriteLockHeld)
            {
