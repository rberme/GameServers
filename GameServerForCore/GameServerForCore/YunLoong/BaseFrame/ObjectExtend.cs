...
namespace YunLoong
{
    ...
    public static class ObjectExtend
    {
        ...
        {
            return GUtils.IsEquals(a, b, ignoreCase);
        }
        ...
        {
            return GUtils.StartsWith(a, b, ignoreCase);
        }
        /// <summary>
        ...
        {
            return GUtils.IsNullOrDbNull(value);
        }
        ...
        {
            return GUtils.GetPaging<T>(list, pageIndex, pageSize, out pageCount, out recordCount);
        }
        ...
        {
            GUtils.InsertSort<T>(list, item, comparison);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            return GUtils.QuickSort(list, (x, y) =>
            {
        ...
        {
            GUtils.QuickSort(list, comparison);
        }
        ...
        {
            return GUtils.IndexOf(bytes, pattern);
        }
        ...
        {
            return GUtils.IndexOf(bytes, offset, length, pattern);
        }
        ...
        {
            return GUtils.ToNotNullString(value);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            return GUtils.ToNotNullString(value, defValue);
        }
        /// <summary>
        /// 向上取整
        /// </summary>
        ...
        {
            return GUtils.ToCeilingInt(value);
        }
        /// <summary>
        /// 向下取整
        /// </summary>
        ...
        {
            return GUtils.ToFloorInt(value);
        }
        ...
        {
            return ToDateTime(value, GUtils.SqlMinDate);
        }
        ...
        {
            return GUtils.ToDateTime(value, defValue);
        }
        ...
        {
            return GUtils.ToEnum(value, type);
        }
        ...
        {
            return IsValid(value, GUtils.ZeroNum, long.MaxValue);
        }
        ...
        {
            return IsValid(value, GUtils.ZeroNum, int.MaxValue);
        }
        /// <summary>
        /// 检查值范围是否有效
        /// </summary>
        ...
        {
            return IsValid(value, (short)GUtils.ZeroNum, short.MaxValue);
        }
        /// <summary>
        /// 检查值范围是否有效
        /// </summary>
        ...
        {
            return IsValid(value, (byte)GUtils.ZeroNum, byte.MaxValue);
        }
        /// <summary>
        /// 检查值范围是否有效
        /// </summary>
        ...
        {
            return IsValid(value, GUtils.ZeroNum, double.MaxValue);
        }
        /// <summary>
        /// 检查值范围是否有效
        /// </summary>
        ...
        {
            return IsValid(value, GUtils.ZeroNum, decimal.MaxValue);
        }
        /// <summary>
        /// 检查值范围是否有效
        /// </summary>
